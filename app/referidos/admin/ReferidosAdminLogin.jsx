...
export default function ReferidosAdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/referidos-admin-auth", {
        method: "POST",
      ...
      // para que app/referidos/admin/page.js (server component) la lea
      // y muestre el panel en vez de este formulario.
      router.refresh();
    } catch (err) {
    ...
    <div className="flex flex-1 items-center justify-center px-4 py-16">
      ...
      >
        <div className="text-center">
          <h1 className="text-lg font-semibold text-zinc-100">Admin — Referidos Mystery</h1>
