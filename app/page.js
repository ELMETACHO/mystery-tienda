...
// placeholder visual para "Recientes" y "Más vendidos" — reemplazar por
// productos reales cuando haya catálogo.
const RECIENTES = [
  { src: "/images/catalogo/IMG_7334.JPG", titulo: "Cuadro personalizado 30x40", precioDesde: 80000 },
  { src: "/images/catalogo/IMG_7336.PNG", titulo: "Cuadro personalizado 40x50", precioDesde: 80000 },
  { src: "/images/catalogo/IMG_7337.PNG", titulo: "Cuadro personalizado 50x70", precioDesde: 80000 },
  { src: "/images/catalogo/IMG_7338.JPG", titulo: "Cuadro personalizado 30x40", precioDesde: 80000 },
];
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex-1 pt-14">
        {/* 2. HERO — dinámico: mensaje + CTA a la izquierda, imagen de estilo
            de vida (cuadro colgado en un espacio decorado) a la derecha. */}
          ...
          <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-2 md:gap-14">
            <div className="flex flex-col items-center gap-6 text-center md:items-start md:text-left">
              ...
              <h1 className="text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl md:text-6xl">
                Transforma tus mejores recuerdos en cuadros de alta calidad
              </h1>

              <p className="max-w-md text-base text-zinc-400 sm:text-lg">
                Sube tu foto, ajústala y recíbela lista para colgar.
              </p>
            ...
            <div className="relative mx-auto aspect-[1402/1122] w-full max-w-lg overflow-hidden rounded-3xl border border-white/10 shadow-2xl shadow-black/40 md:max-w-none">
              <Image
                src="/images/catalogo/head.png"
                alt="Cuadro personalizado Mystery colgado en un espacio decorado"
                fill
                priority
        ...
        {/* CÓMO FUNCIONA — justo debajo del hero, con íconos grandes y
            mensaje de rapidez para bajar la fricción antes del catálogo. */}
        ...
        {/* 3. CUADROS PERSONALIZADOS — bloque más prominente después del hero */}
        ...
        {/* 6. CATEGORÍAS EMOCIONALES — tarjetas con foto de fondo en vez de
        ...
        {/* 8. PRUEBA SOCIAL — calificación, contador y testimonios con foto. */}
        <section className="px-4 pb-16 sm:px-6 sm:pb-24">
        ...
        {/* PREGUNTAS FRECUENTES — acordeón nativo (details/summary), sin JS
            extra, mismo patrón ya usado en el resumen colapsable del
            checkout. */}
        <section className="px-4 pb-16 sm:px-6 sm:pb-24">
